        ...
        <Row className="justify-content-center">
          <Col lg={8}>
            <div className="text-center mb-4">
              <GatsbyImage image={getImage(logo)} alt="Veterinární ordinace Galen logo" />
            </div>
            <Card className="border-primary">
              ...
              <CardBody className="text-center">
                ...
                <ul className="list-unstyled">
                  ...
                  <li><a href="/kontakt/">Kontakt a ordinační hodiny</a></li>
...
export const Head = () => (
  <>
    ...
    <meta name="description" content="Stránka, kterou hledáte, nebyla nalezena. Veterinární ordinace Galen, Brno-Medlánky." />
    <meta name="keywords" content="veterina, veterinární ordinace, Medlánky" />
  </>
)

export const pageQuery = graphql`query NotFoundPageQuery {
