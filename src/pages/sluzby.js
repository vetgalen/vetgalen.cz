    ...
    <Layout location={location} logo={get(data, 'logo')} icon={get(data, 'icon')}>
      ...
      <Container>
        <Row className="row-offer">
          <Col className="offer" xs={{ order: 2 }} sm={{ order: 2, size: 6 }} md={{ order: 2, size: 6 }}>
            ...
            <ul>
              ...
              <li>čipování a vystavení Petpasu, vyšetření zvířete před cestou do zahraničí</li>
              <li>preventivní klinické vyšetření</li>
              <li>geriatrický program</li>
            </ul>
          </Col>
          <Col className="text-center" xs={{ order: 1 }} sm={{ order: 1, size: 6 }} md={{ order: 1, size: 6 }}>
            <Img resolutions={prevence} />
          </Col>
        </Row>
        <Row className="row-offer">
          <Col className="offer" xs={{ order: 2 }} sm={{ order: 1, size: 6 }} md={{ order: 1, size: 6 }}>
            <h3>Odběry krve</h3>
            <ul>
              <li>zajištění biochemického, hematologického a endokrinologického vyšetření ve
                specializované veterinární laboratoři
              </li>
            </ul>
          </Col>
          <Col className="text-center" xs={{ order: 1 }} sm={{ order: 1, size: 6 }} md={{ order: 2, size: 6 }}>
        ...
        <Row className="row-offer">
          <Col className="offer" xs={{ order: 2 }} sm={{ order: 1, size: 6 }} md={{ order: 1, size: 6 }}>
            <h3>Dermatologie</h3>
            <ul>
              <li>vyšetření, odběr vzorků pro další diagnostiku, kultivace na dermatofyta</li>
            </ul>
          </Col>
          <Col className="text-center" xs={{ order: 1 }} sm={{ order: 1, size: 6 }} md={{ order: 2, size: 6 }}>
        ...
        <Row>
          <Col xs={{ order: 2 }} sm={{ order: 1, size: 6 }} md={{ order: 1, size: 6 }}>
            Papkes
            <p>
        ...
        <Row>
          <Col xs={{ order: 2 }} sm={{ order: 2, size: 6 }} md={{ order: 2, size: 6 }}>
            Packa
            <p>
              Lorem ipsum dolor sit amet, est brute errem invidunt et, accumsan
              efficiendi sadipscing est ea, at quo novum epicurei. Nam in quod
